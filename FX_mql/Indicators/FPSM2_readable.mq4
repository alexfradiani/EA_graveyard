...
//string gsa_196[28] = {"AUDCAD", "AUDCHF", "AUDJPY", "AUDNZD", "AUDUSD", "CADCHF", "CADJPY", "CHFJPY", "EURAUD", "EURCAD", "EURCHF", "EURGBP", "EURJPY", "EURNZD", "EURUSD", "GBPAUD", "GBPCAD", "GBPCHF", "GBPJPY", "GBPNZD", "GBPUSD", "NZDCAD", "NZDCHF", "NZDJPY", "NZDUSD", "USDCAD", "USDCHF", "USDJPY"};
...
void start() {
   ...
   for (int index_0 = 0; index_0 < index_4; index_0++) {
    ...
    for(int i = 0, j = 0; i < 28; i++, j += 2) {
        pairsBuffer[j] = gda_212[i][0];
        pairsBuffer[j + 1] = gda_212[i][1];    
    }
