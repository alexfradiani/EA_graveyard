...
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//|        March 16/2008 Goingforwared (Forex-TSD) added email Alert |
//+------------------------------------------------------------------+
...
extern string note1 ="turn on Color = 1; turn off = 0";
...
extern string note2 ="turn on Alert = 1; turn off = 0";
   ...
   {	
	...
	if (Weight > 0) MABuffer[shift] = (1.0+Deviation/100)*Sum/Weight;
      ...
      if (MABuffer[shift+1]-MABuffer[shift] > Filter) trend[shift]=-1; 
         ...
         if (WarningMode>0 && trend[shift+1]<0 && shift==0) SendMail("NonLagMa", "DownTrendAlert");
         }
         if (trend[shift]<0) 
         {
         ...
         if (WarningMode>0 && trend[shift+1]>0 && shift==0) SendMail("NonLagMa", "UpTrendAlert");
         }
      }
   }
//----------   
   ...
   if ( trend[2]<0 && trend[1]>0 /*&& Volume[0]>1*/ && !UpTrendAlert)
	...
	if(SendAlertEmail) SendMail("NonLagMa", "UpTrendAlert");
	...
	if(SendAlertEmail) SendMail("NonLagMa", "DownTrendAlert");
