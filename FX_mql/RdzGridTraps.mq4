...
input          enOrderOperation        OrderOperation             = StopOrders; //StopOrders; //Order Operation
input          int                     OrderCountPerSide          = 4; //Order Count (each side)
...
input          int                     RecreationThreshold        = 33; //Recreation Threshold (in Points)
input          int                     GridStepPoints             = 33; //Grid Step (in Points)
input          int                     CurrentPriceInterval       = 33; //Current Price Interval
